...
public class DriveSubsystem extends SubsystemBase {
  ...
  private final MotorControllerGroup SCG_R = new MotorControllerGroup(rightFront, rightBack); 
  private final MotorControllerGroup SCG_L = new MotorControllerGroup(leftFront, leftBack);   
